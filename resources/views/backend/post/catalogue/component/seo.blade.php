<div class="ibox">
    ...
    <div class="ibox-content">
        <div class="seo-container">
            ...
            <div class="canonical">
                {{ (old('canonical', ($postCatalogue->canonical) ?? '')) ? config('app.url').old('canonical', ($postCatalogue->canonical) ?? '').
                ...
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <textarea
                            ...
                            class="form-control"
                            placeholder=""
                            autocomplete="off">{{ old('meta_description', ($postCatalogue->meta_description) ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row mb-15">
